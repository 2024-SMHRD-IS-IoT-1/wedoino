...
const Login2 = () => {
    ...
    useEffect(() => {
        ...
        //axios를 통한 데이터 전송
        try {
            instance.post('/regist/permit').then((res)=>{
                console.log(res)
            })
        } catch (error) {
            console.log(error);
    ...
    return (
        <div className='page'>
            <br />
            <h1>홍길동(0000.00.00) 연락처 000-0000-0000 님의 사원 등록 요청입니다
                <br />아래 정보를 입력하고 등록 완료를 눌러주세요."</h1>
            ...
            <br /><br />
            <input className='bottomButton' type='submit' value='등록 완료' onClick={() => {
                setUserDatas({
                    userregion: region,
